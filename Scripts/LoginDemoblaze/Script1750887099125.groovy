...
WebUI.setText(findTestObject('Object Repository/LoginDemoblaze/Page_STORE/input_Username_sign-username'), 'ErickCabreraQA')
...
WebUI.setText(findTestObject('Object Repository/LoginDemoblaze/Page_STORE/input_Username_loginusername'), 'ErickCabrera')

WebUI.click(findTestObject('Object Repository/LoginDemoblaze/Page_STORE/form_Username                              _e8be8d'))

WebUI.setText(findTestObject('Object Repository/LoginDemoblaze/Page_STORE/input_Username_loginusername'), 'ErickCabreraQA')
